...
export default function Footer() {
  function Countries({ country }) {
    return (
      <li className="text-secondary">
        <i className="fa-solid fa-earth-asia"></i> Flights to{" "}
  ...
  function Cities({ city }) {
    return (
      <li className="text-secondary">
        <i className="fa-solid fa-location-dot"></i> Flights to{" "}
        <a href="#" className="text-light text-decoration-none">
          {city.name}
        </a>
      </li>
  ...
  function Sites2({ site2 }) {
    return (
      <li>
        <img src={site2.image} width="16px" />
        &nbsp; {site2.name}
      </li>
    );
  }
  ...
  function Links({ link }) {
    return <li className="mx-2"> {link.label} </li>;
  }
  return (
        ...
        <div className="row">
          ...
          <div className="col-lg-5 col-md-12 d-sm-flex text-light">
            <div className="list-unstyled col-sm-6">
              <li style={{ fontSize: "20px" }}>International Sites</li>
              <br />
          ...
          <div className="row" style={{ color: "#8d8f94" }}>
            <div className="d-sm-flex">
              ...
              <ul className="list-unstyled d-md-flex bottom mt-1">
                ...
                <li className="iconlist text-center ms-lg-5">
                  <i
                    className="fa-brands fa-twitter ic"
                    style={{ color: "#606162", fontSize: "larger" }}
                  ></i>
                  &nbsp;
                  <i
                    className="fa-brands fa-facebook ic"
                    style={{ color: "#8a8c8f", fontSize: "larger" }}
                  ></i>
                  &nbsp;
                  <i
                    className="fa-brands fa-google-plus ic"
                    style={{ color: "#77797e", fontSize: "larger" }}
                  ></i>
                  &nbsp;
                </li>
              </ul>
            ...
            <div className="ms-sm-5">
              "This design was crafted by @Rupali Bisale, showcasing meticulous
